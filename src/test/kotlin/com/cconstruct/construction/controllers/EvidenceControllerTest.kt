...
class EvidenceControllerTest {
    ...
    fun should_return_all_evidences() {
        ...
        val result = mockMvc.perform(get(BASE_URL).contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    fun should_get_evidence_by_id() {
        ...
        val result = mockMvc.perform(get("$BASE_URL/1").contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
    ...
    fun should_return_404_when_getting_nonexistent_evidence() {
        ...
        val result = mockMvc.perform(get("$BASE_URL/999").contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isNotFound())
            .andReturn()
